...
class Medusa(Character):
    """
    A figure of Medusa, inherited from the object Character and right are defined in the object creation object type,
    starting point, force, quantity of life, address walking image, address image attack etc.
    """
...
class Wizard(Character):
    """
    A figure of Wizard, inherited from the object Character and right are defined in the object creation object type,
    starting point, force, quantity of life, address walking image, address image attack etc.
    """
    def __init__(self, x, y, side, screen):
...
class Minotaur(Character):
    """
    A figure of Minotaur, inherited from the object Character and right are defined in the object creation object type,
    starting point, force, quantity of life, address walking image, address image attack etc.
    """
    def __init__(self, x, y, side, screen):
...
class Skeleton(Character):
    """
    A figure of Skeleton, inherited from the object Character and right are defined in the object creation object type,
    starting point, force, quantity of life, address walking image, address image attack etc.
    """
    def __init__(self, x, y, side, screen):
...
class Golem(Character):
    """
    A figure of Golem, inherited from the object Character and right are defined in the object creation object type,
    starting point, force, quantity of life, address walking image, address image attack etc.
    """
    def __init__(self, x, y, side, screen):
...
class Knight(Character):
    """
    A figure of Knight, inherited from the object Character and right are defined in the object creation object type,
    starting point, force, quantity of life, address walking image, address image attack etc.
    """
    def __init__(self, x, y, side, screen):
